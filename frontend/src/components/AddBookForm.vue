        ...
        <div class="col-md-8">
          ...
          >
            ...
            <fieldset class="row mb-3">
              <legend class="col-form-label col-sm-3 pt-0 text-end">Format</legend>
              <div class="col-sm-9">
              ...
              <div class="row mb-3">
              <label class="col-sm-3 col-form-label text-end">Original Price</label>
              <div class="col-sm-9 text-start">
                <input
                  type="number"
                  step=".01"
                  ...
                  :class="{
                    'is-invalid':
                      validationStatus($v.originalPrice) || validationErrors.originalPrice,
                  }"
                />
            ...
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label text-end">Selling Price</label>
              <div class="col-sm-9 text-start">
                <input
                  type="number"
                  step=".01"
                  ...
                  :class="{
                    'is-invalid':
                      validationStatus($v.sellingPrice) || validationErrors.sellingPrice,
                  }"
                />
            ...
            <fieldset class="row mb-3">
              <legend class="col-form-label col-sm-3 pt-0 text-end">Condition</legend>
              <div class="col-sm-9">
                <div class="form-check text-start">
                  <input
                    class="form-check-input"
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9 text-start">
  <input class="form-control" type="file" id="file" ref="file" accept="image/*" @change="handlePictureUpload">
              </div>
            </div>
    ...
    <button type="submit" class="btn btn-outline-secondary px-5"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-plus" viewBox="0 0 16 16">
...
export default {
  ...
  methods: {
    ...
    submit: function() {
      ...
      formData.append("purchasing_date", this.purchasing_date);
